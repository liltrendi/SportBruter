...
SportBruter is a little script I wrote (I was bored; to test my skills) to try and authenticate as a user against a defined list of passwords on the login page of [SportPesa](https://sportpesa.co.ke), a Kenyan sports betting platform.
