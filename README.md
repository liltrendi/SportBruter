...
SportBruter is a little script I wrote that tries to authenticate as a user against a defined list of passwords on the login page of [SportPesa](https://sportpesa.co.ke), a Kenyan sports betting platform.
