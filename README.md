...
SportBruter is a little script I wrote (cause I was bored; to test my skills) to try and authenticate as a user against a defined list of passwords on the login page of [SportPesa](https://sportpesa.co.ke), a Kenyan sports betting platform.
